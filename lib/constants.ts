...
export const HERO_VIDEO_SRC = "https://ik.imagekit.io/dwd84qm1d/hero.mp4";

export const SHOWCASE_BG_VIDEO_SRC =
  "https://ik.imagekit.io/dwd84qm1d/showcase.mp4";
...
export const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  ...
  },
  {
    ...
    body: "Pixora restyles the image while protecting composition, identity cues, and the small details that matter.",
    icon: SparklesIcon,
    featured: true,
  },
];